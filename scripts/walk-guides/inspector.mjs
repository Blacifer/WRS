...
export const GUIDE = {
  ...
  '2.18': { title: 'Reading a wagon number with the camera', group: 'camera',
    do: ['Home → <b>Switch wagon</b> → <b>All wagons</b> → tap the camera icon <b>Read the number painted on the wagon</b>.', 'Point at the <b>eleven stencilled digits</b> — a sheet with <b>22057123457</b> in large bold digits is enough (a valid BOXNHL number). Not the SER/BOXNHL/… form: that is typed.'],
    see: ['The camera opens with a frame guide the width of a stencilled number.', 'It proposes the digits and the wagon type they imply; you <b>confirm</b> or correct. Nothing is recorded until you confirm.', 'A number whose check digit fails is not offered; letters are never read.'],
    ...
    ifNot: ['Reads nothing: you are pointing at letters (SER/BOXNHL/…) or a number with a wrong check digit — use the eleven digits; more light, closer, hold still. Typing the number is always there beneath.'],
