...
const CASNUB_CHECKLIST_TEMPLATE: ChecklistTemplateItem[] = [
  // 1. SPRINGS
  ...
  { category: 'BEARINGS', partName: 'Grease Seals & End Cap Bolts', bogiePosition: 'BOGIE_2', isMandatory: 1, std: 'RDSO G-81' },
  ...
  { category: 'BRAKE_SYSTEM', partName: 'Air Hose & Angle Cocks', bogiePosition: 'BODY', isMandatory: 1, std: 'RDSO 02-ABR-02' },
  ...
  { category: 'COUPLERS_DRAFT_GEAR', partName: 'CBC Knuckle Nose Wear', bogiePosition: 'BODY', isMandatory: 1, std: 'RDSO 48-BD-08' },
  { category: 'COUPLERS_DRAFT_GEAR', partName: 'Mark-50 Draft Gear Housing', bogiePosition: 'BODY', isMandatory: 1, std: 'RDSO 49-BD-08' },
  { category: 'COUPLERS_DRAFT_GEAR', partName: 'Striker Casting Wear Plate', bogiePosition: 'BODY', isMandatory: 1, std: 'RDSO 48-BD-08' },
...
const isDirectRun = Boolean(
  process.argv[1] && (
    process.argv[1].endsWith('seedDemo.ts') ||
    process.argv[1].endsWith('seedDemo.js') ||
    process.argv[1].includes('seedDemo')
  )
);
