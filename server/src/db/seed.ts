...
// The master checklist moved to its own module (checklistTemplate.ts): it is
// production data applied to real wagon registrations, not demo seed data.
// Re-exported here so existing importers are unaffected.
export type { ChecklistTemplateItem } from './checklistTemplate.ts';
export { CASNUB_CHECKLIST_TEMPLATE } from './checklistTemplate.ts';
